      ...
      <div className="flex flex-wrap gap-3">
        <form onSubmit={handleSearch} className="flex gap-2">
          <input
            ...
            className="px-3 py-2 bg-gray-900 border border-gray-700 rounded-lg text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500 w-64"
          />
          <button
            type="submit"
        ...
        <select
          ...
          className="px-3 py-2 bg-gray-900 border border-gray-700 rounded-lg text-sm text-white focus:outline-none"
        >
      ...
      {isLoading ? (
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden">
          <table className="w-full text-sm">
            ...
            <tbody>
              {users.map((u) => (
                <tr key={u._id} className="border-b border-gray-800/50 last:border-0 hover:bg-gray-800/30">
